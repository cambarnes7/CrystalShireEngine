...
; Generation 3 moves
	...
	const AIR_CUTTER    ; fd
	const ARM_THRUST    ; fe
	const AROMATHERAPY  ; ff
	const ASSIST        ; 100
	const ASTONISH      ; 101
	const BLAST_BURN    ; 102
	const BLAZE_KICK    ; 103
	const BLOCK         ; 104
	const BOUNCE        ; 105
	const BRICK_BREAK   ; 106
	const BULK_UP       ; 107
	const BULLET_SEED   ; 108
	const CALM_MIND     ; 109
	const CAMOUFLAGE    ; 10a
	const CHARGE        ; 10b
	const COSMIC_POWER  ; 10c
	const COVET         ; 10d
	const CRUSH_CLAW    ; 10e
	const DIVE          ; 10f
	const DOOM_DESIRE   ; 110
	const DRAGON_CLAW   ; 111
	const DRAGON_DANCE  ; 112
	const ENDEAVOR      ; 113
	const ERUPTION      ; 114
	const EXTRASENSORY  ; 115
	const FACADE        ; 116
	const FAKE_TEARS    ; 117
	const FEATHER_DANCE ; 118
	const FLATTER       ; 119
	const FOCUS_PUNCH   ; 11a
	const FOLLOW_ME     ; 11b
	const FRENZY_PLANT  ; 11c
	const GRASS_WHISTLE ; 11d
	const GRUDGE        ; 11e
	const HAIL          ; 11f
	const HEAT_WAVE     ; 120
	const HELPING_HAND  ; 121
	const HOWL          ; 122
	const HYDRO_CANNON  ; 123
	const HYPER_VOICE   ; 124
	const ICE_BALL      ; 125
	const ICICLE_SPEAR  ; 126
	const IMPRISON      ; 127
	const INGRAIN       ; 128
	const IRON_DEFENSE  ; 129
	const KNOCK_OFF     ; 12a
	const LEAF_BLADE    ; 12b
	const LUSTER_PURGE  ; 12c
	const MAGIC_COAT    ; 12d
	const MAGICAL_LEAF  ; 12e
	const MEMENTO       ; 12f
	const METAL_SOUND   ; 130
	const METEOR_MASH   ; 131
	const MIST_BALL     ; 132
	const MUD_SHOT      ; 133
	const MUD_SPORT     ; 134
	const MUDDY_WATER   ; 135
	const NATURE_POWER  ; 136
	const NEEDLE_ARM    ; 137
	const ODOR_SLEUTH   ; 138
	const OVERHEAT      ; 139
	const POISON_FANG   ; 13a
	const POISON_TAIL   ; 13b
	const PSYCHO_BOOST  ; 13c
	const RECYCLE       ; 13d
	const REFRESH       ; 13e
	const REVENGE       ; 13f
	const ROCK_BLAST    ; 140
	const ROCK_TOMB     ; 141
	const ROLE_PLAY     ; 142
	const SAND_TOMB     ; 143
	const SECRET_POWER  ; 144
	const SHADOW_PUNCH  ; 145
	const SHEER_COLD    ; 146
	const SHOCK_WAVE    ; 147
	const SIGNAL_BEAM   ; 148
	const SILVER_WIND   ; 149
	const SKILL_SWAP    ; 14a
	const SKY_UPPERCUT  ; 14b
	const SLACK_OFF     ; 14c
	const SMELLING_SALT ; 14d
	const SNATCH        ; 14e
	const SPIT_UP       ; 14f
	const STOCKPILE     ; 150
	const SUPERPOWER    ; 151
	const SWALLOW       ; 152
	const TAIL_GLOW     ; 153
	const TAUNT         ; 154
	const TEETER_DANCE  ; 155
	const TICKLE        ; 156
	const TORMENT       ; 157
	const TRICK         ; 158
	const UPROAR        ; 159
	const VOLT_TACKLE   ; 15a
	const WATER_PULSE   ; 15b
	const WATER_SPORT   ; 15c
	const WATER_SPOUT   ; 15d
	const WEATHER_BALL  ; 15e
	const WILL_O_WISP   ; 15f
	const WISH          ; 160
	const YAWN          ; 161
