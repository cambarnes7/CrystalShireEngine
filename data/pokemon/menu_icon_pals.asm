...
; Generation 3 Pokemon
	...
	icon_pals GREEN,  GREEN  ; SCEPTILE
	icon_pals RED,    RED    ; TORCHIC
	icon_pals RED,    RED    ; COMBUSKEN
	icon_pals RED,    RED    ; BLAZIKEN
	icon_pals BLUE,   BLUE   ; MUDKIP
	icon_pals BLUE,   BLUE   ; MARSHTOMP
	icon_pals BLUE,   BLUE   ; SWAMPERT
	icon_pals GRAY,   GRAY   ; POOCHYENA
	icon_pals GRAY,   GRAY   ; MIGHTYENA
	icon_pals BROWN,  BROWN  ; ZIGZAGOON
	icon_pals BROWN,  BROWN  ; LINOONE
	icon_pals RED,    RED    ; WURMPLE
	icon_pals GRAY,   GRAY   ; SILCOON
	icon_pals TEAL,   TEAL   ; BEAUTIFLY
	icon_pals PURPLE, PURPLE ; CASCOON
	icon_pals GREEN,  GREEN  ; DUSTOX
	icon_pals GREEN,  GREEN  ; LOTAD
	icon_pals GREEN,  GREEN  ; LOMBRE
	icon_pals GREEN,  GREEN  ; LUDICOLO
	icon_pals BROWN,  BROWN  ; SEEDOT
	icon_pals BROWN,  BROWN  ; NUZLEAF
	icon_pals BROWN,  BROWN  ; SHIFTRY
	icon_pals BLUE,   BLUE   ; TAILLOW
	icon_pals BLUE,   BLUE   ; SWELLOW
	icon_pals BLUE,   BLUE   ; WINGULL
	icon_pals BLUE,   BLUE   ; PELIPPER
	icon_pals GREEN,  GREEN  ; RALTS
	icon_pals GREEN,  GREEN  ; KIRLIA
	icon_pals GREEN,  GREEN  ; GARDEVOIR
	icon_pals BLUE,   BLUE   ; SURSKIT
	icon_pals BLUE,   BLUE   ; MASQUERAIN
	icon_pals GREEN,  GREEN  ; SHROOMISH
	icon_pals GREEN,  GREEN  ; BRELOOM
	icon_pals BROWN,  BROWN  ; SLAKOTH
	icon_pals BROWN,  BROWN  ; VIGOROTH
	icon_pals BROWN,  BROWN  ; SLAKING
	icon_pals BROWN,  BROWN  ; NINCADA
	icon_pals BROWN,  BROWN  ; NINJASK
	icon_pals BROWN,  BROWN  ; SHEDINJA
	icon_pals PINK,   PINK   ; WHISMUR
	icon_pals PURPLE, PURPLE ; LOUDRED
	icon_pals PURPLE, PURPLE ; EXPLOUD
	icon_pals BROWN,  BROWN  ; MAKUHITA
	icon_pals BROWN,  BROWN  ; HARIYAMA
	icon_pals BLUE,   BLUE   ; AZURILL
	icon_pals GRAY,   GRAY   ; NOSEPASS
	icon_pals PINK,   PINK   ; SKITTY
	icon_pals PINK,   PINK   ; DELCATTY
	icon_pals PURPLE, PURPLE ; SABLEYE
	icon_pals GRAY,   GRAY   ; MAWILE
	icon_pals GRAY,   GRAY   ; ARON
	icon_pals GRAY,   GRAY   ; LAIRON
	icon_pals GRAY,   GRAY   ; AGGRON
	icon_pals BLUE,   BLUE   ; MEDITITE
	icon_pals RED,    RED    ; MEDICHAM
	icon_pals GREEN,  GREEN  ; ELECTRIKE
	icon_pals BLUE,   BLUE   ; MANECTRIC
	icon_pals RED,    RED    ; PLUSLE
	icon_pals BLUE,   BLUE   ; MINUN
	icon_pals GRAY,   GRAY   ; VOLBEAT
	icon_pals PURPLE, PURPLE ; ILLUMISE
	icon_pals GREEN,  GREEN  ; ROSELIA
	icon_pals GREEN,  GREEN  ; GULPIN
	icon_pals PURPLE, PURPLE ; SWALOT
	icon_pals RED,    RED    ; CARVANHA
	icon_pals BLUE,   BLUE   ; SHARPEDO
	icon_pals BLUE,   BLUE   ; WAILMER
	icon_pals BLUE,   BLUE   ; WAILORD
	icon_pals BROWN,  BROWN  ; NUMEL
	icon_pals RED,    RED    ; CAMERUPT
	icon_pals RED,    RED    ; TORKOAL
	icon_pals GRAY,   GRAY   ; SPOINK
	icon_pals PURPLE, PURPLE ; GRUMPIG
	icon_pals BROWN,  BROWN  ; SPINDA
	icon_pals BROWN,  BROWN  ; TRAPINCH
	icon_pals GREEN,  GREEN  ; VIBRAVA
	icon_pals GREEN,  GREEN  ; FLYGON
	icon_pals GREEN,  GREEN  ; CACNEA
	icon_pals GREEN,  GREEN  ; CACTURNE
	icon_pals BLUE,   BLUE   ; SWABLU
	icon_pals BLUE,   BLUE   ; ALTARIA
	icon_pals GRAY,   GRAY   ; ZANGOOSE
	icon_pals PURPLE, PURPLE ; SEVIPER
	icon_pals BROWN,  BROWN  ; LUNATONE
	...
	icon_pals BROWN,  BROWN  ; BALTOY
	icon_pals BROWN,  BROWN  ; CLAYDOL
	icon_pals PURPLE, PURPLE ; LILEEP
	icon_pals GREEN,  GREEN  ; CRADILY
	icon_pals GRAY,   GRAY   ; ANORITH
	icon_pals GRAY,   GRAY   ; ARMALDO
	icon_pals BROWN,  BROWN  ; FEEBAS
	icon_pals PINK,   PINK   ; MILOTIC
	icon_pals GRAY,   GRAY   ; CASTFORM
	icon_pals GREEN,  GREEN  ; KECLEON
	icon_pals GRAY,   GRAY   ; SHUPPET
	icon_pals GRAY,   GRAY   ; BANETTE
	icon_pals GRAY,   GRAY   ; DUSKULL
	icon_pals GRAY,   GRAY   ; DUSCLOPS
	icon_pals GREEN,  GREEN  ; TROPIUS
	icon_pals BLUE,   BLUE   ; CHIMECHO
	icon_pals GRAY,   GRAY   ; ABSOL
	icon_pals BLUE,   BLUE   ; WYNAUT
	icon_pals GRAY,   GRAY   ; SNORUNT
	icon_pals GRAY,   GRAY   ; GLALIE
	icon_pals BLUE,   BLUE   ; SPHEAL
	icon_pals BLUE,   BLUE   ; SEALEO
	icon_pals BLUE,   BLUE   ; WALREIN
	icon_pals BLUE,   BLUE   ; CLAMPERL
	icon_pals BLUE,   BLUE   ; HUNTAIL
	icon_pals PINK,   PINK   ; GOREBYSS
	icon_pals BROWN,  BROWN  ; RELICANTH
	icon_pals PINK,   PINK   ; LUVDISC
	icon_pals BLUE,   BLUE   ; BAGON
	icon_pals GRAY,   GRAY   ; SHELGON
	icon_pals RED,    RED    ; SALAMENCE
	icon_pals GRAY,   GRAY   ; BELDUM
	icon_pals GRAY,   GRAY   ; METANG
	icon_pals GRAY,   GRAY   ; METAGROSS
	icon_pals BROWN,  BROWN  ; REGIROCK
	icon_pals BLUE,   BLUE   ; REGICE
	icon_pals GRAY,   GRAY   ; REGISTEEL
	icon_pals RED,    RED    ; LATIAS
	icon_pals BLUE,   BLUE   ; LATIOS
	icon_pals BLUE,   BLUE   ; KYOGRE
	icon_pals RED,    RED    ; GROUDON
	icon_pals GREEN,  GREEN  ; RAYQUAZA
	icon_pals GRAY,   GRAY   ; JIRACHI
