...
MonMenuIconPals:
	...
	db PURPLE, BROWN ; TREECKO
	db PURPLE, BROWN ; GROVYLE
	db PURPLE, BROWN ; SCEPTILE
	db PURPLE, BROWN ; TORCHIC
	db PURPLE, BROWN ; COMBUSKEN
	db PURPLE, BROWN ; BLAZIKEN
	db PURPLE, BROWN ; MUDKIP
	db PURPLE, BROWN ; MARSHTOMP
	db PURPLE, BROWN ; SWAMPERT
	db PURPLE, BROWN ; POOCHYENA
	db PURPLE, BROWN ; MIGHTYENA
	db PURPLE, BROWN ; ZIGZAGOON
	db PURPLE, BROWN ; LINOONE
	db PURPLE, BROWN ; WURMPLE
	db PURPLE, BROWN ; SILCOON
	db PURPLE, BROWN ; BEAUTIFLY
	db PURPLE, BROWN ; CASCOON
	db PURPLE, BROWN ; DUSTOX
	db PURPLE, BROWN ; LOTAD
	db PURPLE, BROWN ; LOMBRE
	db PURPLE, BROWN ; LUDICOLO
	db PURPLE, BROWN ; SEEDOT
	db PURPLE, BROWN ; NUZLEAF
	db PURPLE, BROWN ; SHIFTRY
	db PURPLE, BROWN ; TAILLOW
	db PURPLE, BROWN ; SWELLOW
	db PURPLE, BROWN ; WINGULL
	db PURPLE, BROWN ; PELIPPER
	db PURPLE, BROWN ; RALTS
	db PURPLE, BROWN ; KIRLIA
	db PURPLE, BROWN ; GARDEVOIR
	db PURPLE, BROWN ; SURSKIT
	db PURPLE, BROWN ; MASQUERAIN
	db PURPLE, BROWN ; SHROOMISH
	db PURPLE, BROWN ; BRELOOM
	db PURPLE, BROWN ; SLAKOTH
	db PURPLE, BROWN ; VIGOROTH
	db PURPLE, BROWN ; SLAKING
	db PURPLE, BROWN ; NINCADA
	db PURPLE, BROWN ; NINJASK
	db PURPLE, BROWN ; SHEDINJA
	db PURPLE, BROWN ; WHISMUR
	db PURPLE, BROWN ; LOUDRED
	db PURPLE, BROWN ; EXPLOUD
	db PURPLE, BROWN ; MAKUHITA
	db PURPLE, BROWN ; HARIYAMA
	db PURPLE, BROWN ; AZURILL
	db PURPLE, BROWN ; NOSEPASS
	db PURPLE, BROWN ; SKITTY
	db PURPLE, BROWN ; DELCATTY
	db PURPLE, BROWN ; SABLEYE
	db PURPLE, BROWN ; MAWILE
	db PURPLE, BROWN ; ARON
	db PURPLE, BROWN ; LAIRON
	db PURPLE, BROWN ; AGGRON
	db PURPLE, BROWN ; MEDITITE
	db PURPLE, BROWN ; MEDICHAM
	db PURPLE, BROWN ; ELECTRIKE
	db PURPLE, BROWN ; MANECTRIC
	db PURPLE, BROWN ; PLUSLE
	db PURPLE, BROWN ; MINUN
	db PURPLE, BROWN ; VOLBEAT
	db PURPLE, BROWN ; ILLUMISE
	db PURPLE, BROWN ; ROSELIA
	db PURPLE, BROWN ; GULPIN
	db PURPLE, BROWN ; SWALOT
	db PURPLE, BROWN ; CARVANHA
	db PURPLE, BROWN ; SHARPEDO
	db PURPLE, BROWN ; WAILMER
	db PURPLE, BROWN ; WAILORD
	db PURPLE, BROWN ; NUMEL
	db PURPLE, BROWN ; CAMERUPT
	db PURPLE, BROWN ; TORKOAL
	db PURPLE, BROWN ; SPOINK
	db PURPLE, BROWN ; GRUMPIG
	db PURPLE, BROWN ; SPINDA
	db PURPLE, BROWN ; TRAPINCH
	db PURPLE, BROWN ; VIBRAVA
	db PURPLE, BROWN ; FLYGON
	db PURPLE, BROWN ; CACNEA
	db PURPLE, BROWN ; CACTURNE
	db PURPLE, BROWN ; SWABLU
	db PURPLE, BROWN ; ALTARIA
	db PURPLE, BROWN ; ZANGOOSE
	db PURPLE, BROWN ; SEVIPER
	db PURPLE, BROWN ; LUNATONE
	db PURPLE, BROWN ; SOLROCK
	db PURPLE, BROWN ; BARBOACH
	db PURPLE, BROWN ; WHISCASH
	db PURPLE, BROWN ; CORPHISH
	db PURPLE, BROWN ; CRAWDAUNT
	db PURPLE, BROWN ; BALTOY
	db PURPLE, BROWN ; CLAYDOL
	db PURPLE, BROWN ; LILEEP
	db PURPLE, BROWN ; CRADILY
	db PURPLE, BROWN ; ANORITH
	db PURPLE, BROWN ; ARMALDO
	db PURPLE, BROWN ; FEEBAS
	db PURPLE, BROWN ; MILOTIC
	db PURPLE, BROWN ; CASTFORM
	db PURPLE, BROWN ; KECLEON
	db PURPLE, BROWN ; SHUPPET
	db PURPLE, BROWN ; BANETTE
	db PURPLE, BROWN ; DUSKULL
	db PURPLE, BROWN ; DUSCLOPS
	db PURPLE, BROWN ; TROPIUS
	db PURPLE, BROWN ; CHIMECHO
	db PURPLE, BROWN ; ABSOL
	db PURPLE, BROWN ; WYNAUT
	db PURPLE, BROWN ; SNORUNT
	db PURPLE, BROWN ; GLALIE
	db PURPLE, BROWN ; SPHEAL
	db PURPLE, BROWN ; SEALEO
	db PURPLE, BROWN ; WALREIN
	db PURPLE, BROWN ; CLAMPERL
	db PURPLE, BROWN ; HUNTAIL
	db PURPLE, BROWN ; GOREBYSS
	db PURPLE, BROWN ; RELICANTH
	db PURPLE, BROWN ; LUVDISC
	db PURPLE, BROWN ; BAGON
	db PURPLE, BROWN ; SHELGON
	db PURPLE, BROWN ; SALAMENCE
	db PURPLE, BROWN ; BELDUM
	db PURPLE, BROWN ; METANG
	db PURPLE, BROWN ; METAGROSS
	db PURPLE, BROWN ; REGIROCK
	db PURPLE, BROWN ; REGICE
	db PURPLE, BROWN ; REGISTEEL
	db PURPLE, BROWN ; LATIAS
	db PURPLE, BROWN ; LATIOS
	db PURPLE, BROWN ; KYOGRE
	db PURPLE, BROWN ; GROUDON
	db PURPLE, BROWN ; RAYQUAZA
	db PURPLE, BROWN ; JIRACHI
	db PURPLE, BROWN ; DEOXYS
	assert_table_length NUM_POKEMON
